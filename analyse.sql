...
SELECT 	b.epoch_count AS epoch, j.epoch_count AS end, b.channel_value AS accuracy, j.channel_value AS final_accuracy, 
	...
	/*e.layer_class, e.dim, e.dropout_prob,*/ h.cost_desc, a.config_id, a.model_id, a.ext_id, a.train_id, i.max_epochs, c.input_layer_id
...
WHERE c.model_id = a.model_id	
	...
	--AND (experiment_id = 6 OR experiment_id = 5 OR experiment_id = 4) --AND a.config_id = 159
